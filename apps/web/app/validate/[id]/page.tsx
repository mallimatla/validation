            ...
            <div className="relative download-menu-container">
              ...
              {showDownloadMenu && (
                <div className="absolute right-0 mt-2 w-80 bg-slate-800 rounded-lg shadow-xl border border-slate-700 z-50 overflow-hidden">
                  ...
                  <div className="p-2 border-t border-slate-700 bg-purple-900/20">
                    <p className="text-xs text-purple-400 uppercase px-2 font-semibold">AI Creative Studio</p>
                  </div>
                  <button
                    onClick={openGamma}
                    className="w-full text-left px-4 py-3 hover:bg-slate-700 transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-xl">🎨</span>
                      <div className="flex-1">
                        <p className="font-medium text-white">AI Presentation Designer</p>
                        <p className="text-xs text-slate-400">Create stunning visual decks with AI</p>
                      </div>
                      <span className="text-xs bg-purple-600 text-white px-2 py-0.5 rounded">PRO</span>
                    </div>
                  </button>
